...
<body>
    ...
    <div class="menu">
        ...
        <div class="menu-item" tabindex="0" type="button" onclick="location.href='./log.php'">접속 로그<img src="../images/log.png" alt=""></div>
        <div class="menu-item" tabindex="0" type="button" onclick="location.href='../main/index.php'">홈페이지<img src="../images/home.png" alt=""></div>
        <div class="menu-item" tabindex="0" type="button" onclick="location.href='./change_info.php'">계정 설정<img src="../images/account.png" alt=""></div>
        <div class="menu-item" tabindex="0" type="button" onclick="location.href='./logout.php'">로그아웃<img src="../images/logout.png" alt=""></div>
    </div>
